    ...
    return (
            ...
            <div className="hero-content text-center">
                <div className="max-w-lg">
                    ...
                    <p className="py-6">ByteBlaze is the bridege between the complex world of technology and the curious minds eager to understand it</p>
                    ...
                    <Link to={'/blogs'} className="relative inline-block px-4 py-2 font-medium group">
                            ...
                            <span className="relative text-black group-hover:text-white">Read Blogs Text</span>
                        </Link>
